...
export default function Nav() {
  ...
  const can = (perm: string) => user?.is_sys_admin || permissions.includes(perm);
          ...
          <div className="relative">
            ...
            {showModules && (
              <div className="absolute left-0 mt-2 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-md z-10">
                ...
                {can(Permissions.MOD_INVENT) && (
                  <a href="/inventory" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Inventory</a>
                )}
